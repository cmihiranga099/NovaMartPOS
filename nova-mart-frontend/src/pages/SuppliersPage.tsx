    ...
    <div>
      <div className="flex items-center justify-between mb-1">
        <div>
          ...
          <p className="text-sm text-ink-500 mt-0.5">Manage who you buy stock from</p>
        </div>
        <button
          onClick={openAdd}
      ...
      {!isLoading && filtered.length === 0 && (
        <div className="flex flex-col items-center justify-center py-16 bg-white rounded-2xl border border-dashed border-line text-center">
          ...
          <p className="font-medium text-ink-900">No suppliers found</p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-1 space-y-0.5">
                    ...
                    {!s.phone && !s.email && <p className="text-xs text-ink-500">No contact info</p>}
                  </div>
                </div>
              </div>
